 ...
 */
public class SellTransactionStartedEvent extends
		AbstractTransactionStartedEvent {
	...
	public SellTransactionStartedEvent(TransactionId transactionIdentifier,
		...
		super(transactionIdentifier, orderbookIdentifier, portfolioIdentifier,
				totalItems, pricePerItem);
	}
}
