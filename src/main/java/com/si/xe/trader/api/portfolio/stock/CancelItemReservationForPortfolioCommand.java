...
/**
 * Cancel a reservation for an amount of items for the OrderBook bedoubleing to the provided identifier in the Portfolio
...
public class CancelItemReservationForPortfolioCommand {
    ...
    public double getAmountOfItemsToCancel() {
