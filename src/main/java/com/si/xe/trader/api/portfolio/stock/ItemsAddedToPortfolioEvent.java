...
public class ItemsAddedToPortfolioEvent {
    ...
    private double amountOfItemsAdded;

    public ItemsAddedToPortfolioEvent(PortfolioId portfolioIdentifier, OrderBookId orderBookIdentifier, double amountOfItemsAdded) {
        this.portfolioIdentifier = portfolioIdentifier;
        this.orderBookIdentifier = orderBookIdentifier;
        this.amountOfItemsAdded = amountOfItemsAdded;
    }

    public double getAmountOfItemsAdded() {
