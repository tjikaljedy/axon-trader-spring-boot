...
public class NotEnoughItemsAvailableToReserveInPortfolio {
    ...
    private double availableAmountOfItems;
    private double amountOfItemsToReserve;

    public NotEnoughItemsAvailableToReserveInPortfolio(PortfolioId portfolioIdentifier,
                                                       OrderBookId orderBookIdentifier,
                                                       TransactionId transactionIdentifier,
                                                       double availableAmountOfItems,
                                                       double amountOfItemsToReserve) {
    ...
    public double getAmountOfItemsToReserve() {
        return amountOfItemsToReserve;
    }

    public double getAvailableAmountOfItems() {
