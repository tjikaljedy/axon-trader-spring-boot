...
package com.si.xe.trader.api.users;
...
public class CreateUserCommand {
    ...
    public CreateUserCommand(UserId userId, String name, String username, String password, String exchangeName) {
        ...
        Assert.notNull(exchangeName, "The provided exchangeName cannot be null");
