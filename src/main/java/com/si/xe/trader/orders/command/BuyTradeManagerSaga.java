...
import com.si.xe.trader.api.orders.trades.CreateBuyOrderCommand;
...
public class BuyTradeManagerSaga extends TradeManagerSaga {
    ...
    public void handle(BuyTransactionCancelledEvent event) {
    	double amountToCancel = (event.getTotalAmountOfItems() - event.getAmountOfExecutedItems()) * getPricePerItem();
