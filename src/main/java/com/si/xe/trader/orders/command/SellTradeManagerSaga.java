...
import com.si.xe.trader.api.orders.trades.CreateSellOrderCommand;
...
public class SellTradeManagerSaga extends TradeManagerSaga {
    ...
    public void handle(SellTransactionCancelledEvent event) {
        double amountOfCancelledItems = event.getTotalAmountOfItems() - event.getAmountOfExecutedItems();
