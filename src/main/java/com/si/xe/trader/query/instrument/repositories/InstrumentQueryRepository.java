...
package com.si.xe.trader.query.instrument.repositories;
...
public interface InstrumentQueryRepository extends PagingAndSortingRepository<InstrumentEntry, String> {
	...
	InstrumentEntry findByNameAndExchangeName(@Param("name") String name, @Param("exchangeName") String exchangeName);
}
