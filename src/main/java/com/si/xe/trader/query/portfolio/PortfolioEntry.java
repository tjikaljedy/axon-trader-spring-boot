...
package com.si.xe.trader.query.portfolio;
...
public class PortfolioEntry {
    ...
    /* utility functions                                                                         */
    /*-------------------------------------------------------------------------------------------*/
    public double obtainAmountOfAvailableItemsFor(String orderbookIdentifier) {
        double possession = obtainAmountOfItemsInPossessionFor(orderbookIdentifier);
        double reserved = obtainAmountOfReservedItemsFor(orderbookIdentifier);
        return possession - reserved;
    }

    public double obtainAmountOfReservedItemsFor(String orderbookIdentifier) {
    ...
    public double obtainAmountOfItemsInPossessionFor(String orderbookIdentifier) {
    ...
    public double obtainMoneyToSpend() {
    ...
    public void removeReservedItem(String itemIdentifier, double amount) {
        handleRemoveItem(itemsReserved, itemIdentifier, amount);
    }

    public void removeItemsInPossession(String itemIdentifier, double amount) {
    ...
    public double getReservedAmountOfMoney() {
        return reservedAmountOfMoney;
    }

    public void setReservedAmountOfMoney(double reservedAmountOfMoney) {
    ...
    private void handleAdd(Map<String, ItemEntry> items, ItemEntry itemEntry) {
        if (items.containsKey(itemEntry.getIdentifier())) {
            ...
            System.out.println(">>>> foundEntry: " + foundEntry.getAmount() + " >> " + itemEntry.getAmount());
    ...
    private void handleRemoveItem(Map<String, ItemEntry> items, String itemIdentifier, double amount) {
