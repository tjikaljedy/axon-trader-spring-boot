...
import com.si.xe.trader.api.portfolio.stock.ItemReservationCancelledForPortfolioEvent;
import com.si.xe.trader.api.portfolio.stock.ItemReservationConfirmedForPortfolioEvent;
import com.si.xe.trader.api.portfolio.stock.ItemsAddedToPortfolioEvent;
import com.si.xe.trader.api.portfolio.stock.ItemsReservedEvent;
...
public class PortfolioItemEventListener {
    ...
    private ItemEntry createItemEntry(String identifier, double amount) {
