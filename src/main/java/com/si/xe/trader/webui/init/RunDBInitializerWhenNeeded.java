 ...
 * </p>
 * <p>
 * We need to check for the display name of the application context since we by
 * default have two using spring-mvc the way we do.
 * </p>
 *
 * @author Jettro Coenradie
 */
@Component
public class RunDBInitializerWhenNeeded implements
